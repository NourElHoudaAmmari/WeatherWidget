...
public class MainActivity extends AppCompatActivity {
    ...
    private com.airbnb.lottie.LottieAnimationView idTVIcon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idTVIcon=findViewById(R.id.idTVIcon);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(condition.equals("Overcast")) {
                        idTVIcon.setAnimation(R.raw.oo);
                        idTVIcon.resumeAnimation();
                    }
                    else if(condition.equals("Sunny")) {
                        idTVIcon.setAnimation(R.raw.ss);
                        //  backIV.setImageResource(R.drawable.);
                        idTVIcon.resumeAnimation();
                    }
                    else if(condition.equals("Mist")) {
                        idTVIcon.setAnimation(R.raw.dd);

                        idTVIcon.resumeAnimation();
                    }
                    else {
                        idTVIcon.setAnimation(R.raw.cc);

                        idTVIcon.resumeAnimation();
                    }
                    if (isDay==1){
                        //morning
                        Picasso.get().load("https://images.unsplash.com/photo-1593978301851-40c1849d47d4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=654&q=80").into(backIV);
                    }else{
                    ...
                    Intent intent = new Intent(context, MeteoWidgetReceiver.class);
